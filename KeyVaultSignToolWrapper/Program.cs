    ...
    class Program
    {
        internal static int Main(string[] args)
        {
            ...
            var signCommand = application.Command("sign", throwOnUnexpectedArg: false, configuration: signConfiguration =>
            {
                ...
                {
                    if (string.IsNullOrWhiteSpace(signTool.Value) || string.IsNullOrWhiteSpace(file.Value) || string.IsNullOrWhiteSpace(signToolArgs.Value))
                    {
                    ...
                    return cmd.SignAsync(signTool.Value,
                                         signToolArgs.Value,
                                         file.Value,
